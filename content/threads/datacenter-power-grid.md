...
- **The Department of Energy's Office of Cybersecurity, Energy Security, and Emergency Response published a Request for Information implementing Executive Order 14421** (the bulk-power-system national-emergency order signed 08-26 and already on this thread), opening an eight-category public comment period on scope definitions, supply-chain risk, mitigation of already-installed foreign equipment, licensing, domestic manufacturing capacity and economic impact. **Written comments are due October 9, 2026, and DOE will hold a public webinar September 16, 2026, 3-4pm ET.** This is the first actual regulatory action under the order's 120-day rulemaking deadline (roughly 2026-12-24) that this thread flagged as the "industry's central open question" — the order itself named no Covered Foreign Entities and this RFI does not either; that designation still awaits the eventual rule. Also relevant to [Power Buildout](/threads/ai-power-buildout/), which carries the same EO. ([Federal Register RFI, full text](https://www.federalregister.gov/documents/full_text/text/2026/09/09/2026-18370.txt))
