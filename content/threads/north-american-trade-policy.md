...
entities: []
thread_kind: story
blurb: 'Whether the US-Canada tariff fight is a negotiating posture or a structural
  break, and whether it stays bilateral or widens into a broader G7 trade war. US-Canada
  talks collapsed on 08-24 ("they asked too much," per one side), sliding the Canadian
  dollar about 0.5%; the same afternoon Trump put a dated, quantified schedule behind
  it — autos doubling from 25% to 50%, a new 50% tariff on auto parts (previously
  untariffed), and 50% on steel, all effective 01 January 2027, on top of 50% tariffs
  on $20bn of Canadian goods that took effect the same weekend. Auto executives quoted
  by Reuters were skeptical the January date holds, noting it falls conveniently after
  the November midterms. Track: whether the 2027 tariffs actually take effect or get
  renegotiated before then, any Mexico- or EU-side response, and whether the auto-parts
...
- ✅ **The ledger entry canada-retaliatory-tariffs-effective-0908 resolved hit, confirmed against CBSA's own notice — the magnitude figures are flagged unreconciled above rather than quietly restated.**
