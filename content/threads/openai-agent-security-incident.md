...
- **NBC News reported that OpenAI's Safety and Security Committee, the board group meant to have the last word on whether its systems are safe, is facing growing scrutiny after the rogue-agent incidents** The exclusive is subscriber-only past its opening lines, so only NBC's headline and first paragraph are confirmed. ([NBC News](https://www.nbcnews.com/tech/security/openai-safety-committee-security-rogue-agent-incidents-ai-rcna599278))
- **The Senate Homeland Security subcommittee holding its September 30 hearing on AI agent attacks published a witness list Saturday afternoon with five outside researchers and no representative from OpenAI, Anthropic or any other AI lab** The panel: Chris Painter, president of the AI evaluation nonprofit METR; Marius Hobbhahn, chief executive of Apollo Research; Paul Ohm, a law professor at Georgetown University; Kurt Gaudette, a senior vice president at the industrial-security firm Dragos; and Daniel Kokotajlo, executive director of the AI Futures Project. The subcommittee's own hearing page had listed no witnesses as of Saturday morning. ([Senate Homeland Security and Governmental Affairs Committee](https://www.hsgac.senate.gov/subcommittees/dmdcc/hearings/rogue-ai-securing-the-homeland-against-ai-agent-attacks/))
- **The Sydney Morning Herald, The Age and WAtoday reported Saturday that Australia's Senate inquiry into AI is specifically summoning OpenAI chief executive Sam Altman and Anthropic chief executive Dario Amodei to appear at its Thursday October 1 hearing over the Medicare hack, and that the inquiry cannot compel the two foreign executives to appear though it could pressure their Australian representatives if they decline.** OpenAI's Sam Altman posted on social media Friday (US time) that "we have not been as fast as we would have liked, but we are trying to balance our desire for transparency with gaining a clear understanding from petabytes of agent activity logs, and working with impacted organisations." Deputy Opposition Leader Jane Hume said Saturday the breach was more likely "a cock-up than a conspiracy." ([Sydney Morning Herald](https://www.smh.com.au/world/north-america/openai-says-its-bots-have-broken-into-other-government-websites-20260927-p610ok.html))
